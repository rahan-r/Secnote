            ...
            <CardContent>
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="item-1">
                  <AccordionTrigger className={'font-bold'}>What encryption do you use?</AccordionTrigger>
                  <AccordionContent>
                ...
                <AccordionItem value="item-2">
                  <AccordionTrigger className={'font-bold'}>Is my note really encrypted? Can you see what I write?</AccordionTrigger>
                  <AccordionContent>
                ...
                <AccordionItem value="item-3">
                  <AccordionTrigger className={'font-bold'}>Where is the encryption key stored?</AccordionTrigger>
                  <AccordionContent>
                ...
                <AccordionItem value="item-4">
                  <AccordionTrigger className={'font-bold'}>How long are notes stored before they self-destruct?</AccordionTrigger>
                  <AccordionContent>
                ...
                <AccordionItem value="item-5">
                  <AccordionTrigger className={'font-bold'}>Do you keep logs or metadata?</AccordionTrigger>
                  <AccordionContent>
